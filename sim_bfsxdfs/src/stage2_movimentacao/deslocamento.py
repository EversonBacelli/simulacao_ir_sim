import irsim
from sim_bfsxdfs.src.stage2_movimentacao.main import menorCaminho
from sim_bfsxdfs.src.classes.no import No, Status

env = None
def definirMapa(diretorio):
    global env
    endereco_mapa = '/sim_bfsxdfs/src/matriz/' + diretorio
    env = irsim.make(endereco_mapa)
